    ...
    <footer className="bg-card text-card-foreground pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Restaurant Info */}
          <div>
            <h3 className="text-xl font-serif font-semibold mb-4">Wingi food</h3>
            <p className="text-muted-foreground mb-4">
              Cuisine africaine raffinée, service de restauration à livrer, 
              et service traiteur pour tous vos événements.
            </p>
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/profile.php?id=61565519288789" className="text-foreground/80 hover:text-primary transition-colors">
                <Facebook size={20} />
              </Link>
              <Link href="https://www.instagram.com/wingifood/" className="text-foreground/80 hover:text-primary transition-colors">
                <Instagram size={20} />
              </Link>
              <Link href="https://www.tiktok.com/@wingifood1?_t=ZM-8yomyL7CNXx&_r=1 " className="text-foreground/80 hover:text-primary transition-colors">
                <FaTiktok size={20} />
              </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">contact@wingifood.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/catering" className="text-muted-foreground hover:text-foreground transition-colors">
                  Service traiteur
                </Link>
              </li>
              <li>

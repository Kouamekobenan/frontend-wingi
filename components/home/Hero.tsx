...
export default function Hero() {
  ...
  // ✅ Correction : useCallback pour éviter le closure stale dans useEffect
  ...
  // ✅ Correction : nextSlide dans les dépendances
  useEffect(() => {
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 text-center py-12">
        ...
        >
          ...
          {/* ✅ Correction : tous les boutons dans le même groupe, même taille et style cohérent */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 flex-wrap">
            ...
            {/* ✅ Bouton PDF stylisé de façon cohérente avec les autres */}
            <Button
              size="lg"
              asChild
              className="rounded-full bg-green-600 hover:bg-green-700 shadow-lg transition-transform hover:-translate-y-1 px-8 group"
            >
              <a href="/pdf/service.pdf" download>
                <FileText className="mr-2 h-4 w-4 text-green-100" />

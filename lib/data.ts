...
export const menuItems: MenuItem[] = [
  // nos entrées
  {
    ...
    description:
      "Beignets croustillants à l'extérieur, moelleux à l'intérieur, garnis de thon ou de viande hachée.",
    price: 5.0,
    imageUrl: wingi02,
    categoryId: "entrées",
    isAvailable: true,
  ...
  },
  {
    ...
    name: "Mikaté (x10)",
    description:
      "Beignets sucréés, à la mie aérienne et parfumée d'une touche de vanille.",
    price: 5.0,
    imageUrl: wingi13,
    categoryId: "entrées",
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "Triangle de feuilles fines garnis de légumes et de viandes épicées, croustillants à souhait.",
    price: 5.0,
    imageUrl: wingi5,
  ...
  },
  {
    ...
    name: "Ablo (x6)",
    description:
      "Gâteau de maïs cuit à la vapeur, servis avec sa sauce tomatée.",
    price: 5.0,
    imageUrl: wingi55,
    categoryId: "accompagnements",
    isAvailable: true,
  ...
  //Nos viandes
  {
    ...
    description:
      "Côte d'agneau grillée, sautée avec nos épices maison, oignons rouges et poivrons.",
    price: 14.99,
    imageUrl: wingi33,
    categoryId: "viandes",
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "Morceaux d'agneau marinés, grillés au charbon de bois et servis avec des oignons confits.",
    price: 14.99,
    imageUrl: wingi48,
    categoryId: "viandes",
    isAvailable: true,
  ...
  // Nos volailles
  {
    ...
    description:
      "1/2 poulet braisé, sauté façon choucouya avec ail, oignons et fines herbes.",
    price: 9.99,
    imageUrl: wingi33,
    categoryId: "volailles",
    isAvailable: true,
    preparationTime: 25,
  },
  {
    ...
    description:
      "Poulet entier braisé, sauté façon choucouya avec ail, oignons et fines herbes.",
    price: 14.99,
    imageUrl: wingi33,
    categoryId: "volailles",
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "1/2 poulet mariné 24h dans le mélange d'épices Wingi, grillé lentement au charbon de bois.",
    price: 9.99,
    imageUrl: wingi46,
    categoryId: "volailles",
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "Poulet mariné 24h dans le mélange d'épices Wingi, grillé lentement au charbon de bois.",
    price: 14.99,
    imageUrl: wingi43,
    categoryId: "volailles",
    isAvailable: true,
  ...
  // Nos boissons
  {
    ...
    name: "Bissap 0,5 l",
    description:
      "infusion florale d'hibiscus séchés, relevée d'une pointe de citron vert et d'une note de menthe fraîche",
    price: 3.0,
    imageUrl: img13,
    categoryId: "jus",
    isAvailable: true,
  ...
  },
  {
    ...
    description:
      "Macération de gingembre frais adoucie par un sirop maison au citron",
    price: 3.0,
    imageUrl: img14,
    categoryId: "jus",
    isAvailable: true,
